defmodule MedicalClinicWeb.AppointmentEntry do
  ...
  def render(assigns) do
    ...
    <div class={[
      ...
      if(assigns.appointment.is_checked_in, do: "bg-green-200")
    ]}>
      <p class="text-teal-900 font-light text-3xl"><%= assigns.appointment.patient.name %></p>
      <p class="text-blue-900 text-sm">
        <div class="flex container text-xs flex-col text-right">
          <div :if={assigns.appointment.is_checked_in} class="p-2 font-bold text-xl">
            Checked-in!
          </div>
